...
export default function TopBar() {
  ...
  return (
    <div className="bg-[#001F3F] text-white text-sm font-medium font-sans flex justify-between items-center px-4 py-2">
      
      {/* Left Section: Phone, WhatsApp, Email */}
      ...
      <div className="flex flex-col text-right w-60 relative h-6 overflow-hidden">
        <AnimatePresence>
          <motion.div
            key={current}
            ...
            className="bg-blue-800/30 px-2 py-1 rounded"
          >
